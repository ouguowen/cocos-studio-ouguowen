...
REQUIRED_FILES = [
    ...
    "blueprint/game-blueprint.schema.json",
    "blueprint/blueprint-manager.js",
    "blueprint/README.md",
    "dependency-graph/dependency-schema.json",
    "dependency-graph/dependency-graph.js",
    "dependency-graph/README.md",
    "execution-memory/execution-history.json",
    "execution-memory/execution-memory.js",
    "execution-cache/cache-schema.json",
    "execution-cache/execution-cache.js",
    "execution-cache/task-fingerprint.js",
    "execution-cache/route-score.js",
    "execution-cache/README.md",
    "execution-feedback/feedback-engine.js",
    "execution-feedback/execution-score.js",
    "execution-feedback/failure-memory.js",
    "execution-feedback/success-patterns.json",
    "execution-feedback/feedback-schema.json",
    "execution-feedback/README.md",
    "config/task-routing.json",
    "agent-router/agent-router.js",
    "agent-router/agent-registry.json",
    "agent-router/activation-policy.json",
    "agent-router/README.md",
    "task-router/task-router.js",
    "task-router/fast-execution-path.js",
    "docs/evolution/task-router-fast-lane.md",
    "scripts/test-task-router.js",
    "scripts/test-agent-router.js",
    "scripts/test-blueprint-manager.js",
    "scripts/test-dependency-graph.js",
    "scripts/test-execution-cache.js",
    "scripts/test-execution-feedback.js",
    "scripts/test-execution-memory.js",
    "scripts/test-execution-router.js",
...
CONTENT_CHECKS = {
    ...
    "blueprint/game-blueprint.schema.json": [
        "AI Game Studio Shared Game Blueprint",
        "blueprint_version",
        "execution_enabled",
        "source_request",
        "sections",
    ...
    "blueprint/blueprint-manager.js": [
        "function createGameBlueprint",
        "function validateGameBlueprint",
        "function getAgentBlueprintContext",
        "function buildAgentBlueprintContexts",
        "function analyzeBlueprintChangeImpact",
        "function updateGameBlueprint",
    ...
    "dependency-graph/dependency-schema.json": [
        "AI Game Studio Game Dependency Graph",
        "execution_enabled",
        "nodes",
        "dependencies",
    ],
    ...
    "execution-memory/execution-memory.js": [
        "function loadExecutionMemory",
        "function recordExecutionMemoryDecision",
        "function summarizeExecutionMemory",
        "function buildExecutionMemoryContext",
        "function validateExecutionMemoryStore",
        "execution_enabled",
        "fast_path",
        "full_pipeline",
    ],
    "execution-cache/cache-schema.json": [
        "AI Game Studio Execution Cache",
        "execution_enabled",
        "entries",
        "route_score",
        "score",
    ...
    "execution-cache/execution-cache.js": [
        "function lookupExecutionCache",
        "function updateExecutionCache",
        "function buildCacheHitExecutionMode",
        "function validateExecutionCacheStore",
        "fast_path",
        "full_pipeline",
        "execution_enabled",
    ],
    "execution-feedback/feedback-engine.js": [
        "function evaluateExecutionFeedback",
        "function buildFeedbackRoutingContext",
        "function loadSuccessPatterns",
        "confidence_delta",
        "prefer-route",
        "avoid-route",
        "execution_enabled",
    ...
    "execution-feedback/failure-memory.js": [
        ...
        "function lookupFailurePatterns",
        "classifyError",
        "count",
        "execution_enabled",
    ],
    "execution-feedback/success-patterns.json": [
        "ui.modify.button.cocos",
        "best_route",
        "fast",
        "score",
        "execution_enabled",
    ...
    "execution-feedback/feedback-schema.json": [
        "AI Game Studio Execution Feedback",
        "learning_signal",
        "route_update",
        "execution_enabled",
    ],
    ...
    "agent-router/agent-router.js": [
        ...
        "function validateAgentRouterRegistry",
        "function validateActivationPolicy",
        "buildAgentBlueprintContexts",
        "dependency_impact",
        "prototype-routing-only",
        "execution_enabled !== false",
        "selected_agents",
    ],
    "agent-router/README.md": [
    ...
    "task-router/task-router.js": [
        ...
        "function resolveExecutionFeedbackContext",
        "function resolveExecutionCacheContext",
        "buildExecutionMemoryContext",
        "function chooseAdaptiveExecution",
        "function calculateTaskComplexity",
        "function validateTaskRoutingConfig",
        "Fast Lane may only allow L0 and L1 tasks",
        "fast_path",
        "full_pipeline",
        "execution_enabled false",
        "defaultConfigPath",
    ...
    "task-router/fast-execution-path.js": [
        ...
        "Fast Execution Path only accepts L0 and L1 tasks",
        "executor_is_mock",
        "allowed_stages_only",
    ],
    "docs/evolution/task-router-fast-lane.md": [
    ...
    "scripts/test-execution-memory.js": [
        ...
        "Formal execution history must not be modified",
        "store_written",
    ],
    "scripts/test-execution-router.js": [
        "routeWithBlueprint",
        "fast_path",
        "full_pipeline",
        "assertNoFullPipelineStages",
        "assertFullPipelineStages",
        "修改UI颜色",
        "新增战斗系统",
        "完整游戏生成",
    ],
