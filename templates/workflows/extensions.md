...
Use this file only when the request is not covered by [templates/workflows/core.md](../../templates/workflows/core.md).
...
- Plan the version roadmap: open [production/version-roadmap.md](../../production/version-roadmap.md) and define proof obligation before features.
...
- Work with AI collaborators: open [agents/ai-collab-rules.md](../../agents/ai-collab-rules.md) before delegating any design or code decision.
- Revise a concrete module: apply [protocols/choice-execution.md](../../protocols/choice-execution.md), but offer upgrade directions instead of fresh module directions.
...
- Plan QA coverage: open [production/test-matrix.md](../../production/test-matrix.md) and make deferred coverage explicit.
...
- Run first-week support: apply [protocols/sequential-gate.md](../../protocols/sequential-gate.md) and [production/operations-data.md](../../production/operations-data.md) before normal feature work resumes.
